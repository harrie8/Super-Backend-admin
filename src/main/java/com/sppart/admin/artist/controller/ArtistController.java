...
public class ArtistController {
    ...
    public ResponseEntity<?> getAllArtists(@RequestParam(value = "startDate", required = false) Date startDate,
        ...
        return ResponseEntity.ok(artistService.getAllArtists(startDate, endDate, isUser, searchString, filterType, page));
    }
